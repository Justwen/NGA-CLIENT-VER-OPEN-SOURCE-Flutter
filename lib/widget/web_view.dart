...
class WebviewScaffoldEx extends StatefulWidget {
  const WebviewScaffoldEx({
    Key key,
    this.appBar,
    @required this.url,
    this.headers,
...
class _WebviewScaffoldState extends State<WebviewScaffoldEx> {
  ...
  void initState() {
    ...
    _onStateChanged =
      ...
      print(state.url);
      if (state.type == WebViewState.finishLoad && widget.hidden) {
