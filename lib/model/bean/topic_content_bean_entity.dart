...
class TopicContentBeanDataAttachment {
  String aid;
  String name;
  String attachUrl;
  String type;

  TopicContentBeanDataAttachment(
      {this.attachUrl, this.type, this.name, this.aid});

  factory TopicContentBeanDataAttachment.fromJson(Map<String, dynamic> json) {
    String aid = json['aid'];
    String name = json['name'];
    String attachUrl = json['attachurl'];
    String type = json['type'];
    return TopicContentBeanDataAttachment(
        aid: aid, type: type, attachUrl: attachUrl, name: name);
  }
...
class TopicContentBeanDataRR {
  ...
  List<TopicContentBeanDataAttachment> attachments;

  TopicContentBeanDataRR(
      {this.fid, this.fromClient, this.subject, this.score2, this.postdate, this.pid, this.recommend, this.postdatetimestamp, this.authorid, this.type, this.tid, this.content, this.score, this.lou, this.alterinfo, this.contentLength});
  ...
  TopicContentBeanDataRR.fromJson(Map<String, dynamic> json) {
    ...
    Map attaches = json['attachs'];
    if (attaches != null) {
      attachments = List();
      attaches.forEach((key, value) {
        attachments.add(TopicContentBeanDataAttachment.fromJson(value));
      });
    }
  }
